...
namespace Auto.Website.Controllers.Api {
	...
	public class VehiclesController : ControllerBase {
		...
		public static NewVehicleMessage ToMessage(Vehicle vehicle)
		{
		...
		{
			var message = ToMessage(vehicle);
			await _bus.PubSub.PublishAsync(message);
		}

		// PUT api/vehicles/ABC123
		[HttpPut("{id}")]
		public async Task<IActionResult> Put(string id, [FromBody] dynamic dto) {
